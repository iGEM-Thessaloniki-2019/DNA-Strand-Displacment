...
##this .pil file is used for the simulation and it exports a concentration - time figure 
...
cat first_reaction_data.pil | pilsimulator --atol 1e-13 --rtol 1e-13 --mxstep 100000 --t0 0 --t-log 10000 --t8 360000 --pyplot-labels I1 BA IA B1 --p0 I1=10e-9 BA=0.05e-9 IA=0 B1=0 --pyplot fisrt_reaction_simulation.pdf | tee sss.txt

##Export a csv containing system data
python json_to_csv.py
##Export a figure of the temporary depletion between selected complexes
